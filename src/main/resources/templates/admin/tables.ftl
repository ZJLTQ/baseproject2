...
<#macro overrideHeader>
        ...
        <title>表格 | baseproject2 管理系统</title>
        ...
        <!-- Datatables -->
        <link rel="stylesheet" media="screen" href="${base}/static/css/DT_bootstrap.css">
...
<@layout header=overrideHeader>
        ...
        <script type="text/javascript" src="${base}/static/vendors/datatables/js/jquery.dataTables.min.js"></script>
        <script type="text/javascript" src="${base}/static/js/DT_bootstrap.js"></script>
