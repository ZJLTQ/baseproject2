...
<#macro overrideHeader>
        ...
        <title>仪表盘 | baseproject2 管理系统</title>
        ...
        <!-- Vendors -->
        <link rel="stylesheet" media="screen" href="${base}/static/vendors/easypiechart/jquery.easy-pie-chart.css">
        <link rel="stylesheet" media="screen" href="${base}/static/vendors/easypiechart/jquery.easy-pie-chart_custom.css">
...
<script type="text/javascript" src="${base}/static/vendors/easypiechart/jquery.easy-pie-chart.js"></script>
