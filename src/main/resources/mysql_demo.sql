...
insert into account (id,email,name,hash_password,salt,group_id) values(1,'1@gmail.com','管理员','48577990717ce63726608c92c6ab257f','4sG3vd',1);
insert into account (id,email,name,hash_password,salt) values(2,'2@gmail.com','东方不败','48577990717ce63726608c92c6ab257f','4sG3vd');
insert into account (id,email,name,hash_password,salt) values(3,'3@gmail.com','张三','48577990717ce63726608c92c6ab257f','4sG3vd');
insert into account (id,email,name,hash_password,salt) values(4,'4@gmail.com','李四','48577990717ce63726608c92c6ab257f','4sG3vd');
insert into account (id,email,name,hash_password,salt) values(5,'5@gmail.com','王五','48577990717ce63726608c92c6ab257f','4sG3vd');
insert into account (id,email,name,hash_password,salt) values(6,'6@gmail.com','赵六','48577990717ce63726608c92c6ab257f','4sG3vd');
insert into account (id,email,name,hash_password,salt,group_id) values(7,'7@gmail.com','管理员2','48577990717ce63726608c92c6ab257f','4sG3vd',2);
insert into account (id,email,name,hash_password,salt) values(8,'8@gmail.com','东方不败','48577990717ce63726608c92c6ab257f','4sG3vd');
insert into account (id,email,name,hash_password,salt) values(9,'9@gmail.com','张三','48577990717ce63726608c92c6ab257f','4sG3vd');
insert into account (id,email,name,hash_password,salt) values(10,'10@gmail.com','李四','48577990717ce63726608c92c6ab257f','4sG3vd');
insert into account (id,email,name,hash_password,salt) values(11,'11@gmail.com','王五','48577990717ce63726608c92c6ab257f','4sG3vd');
insert into account (id,email,name,hash_password,salt) values(12,'12@gmail.com','赵六','48577990717ce63726608c92c6ab257f','4sG3vd');
insert into account (id,email,name,hash_password,salt,group_id) values(13,'13@gmail.com','管理员3','48577990717ce63726608c92c6ab257f','4sG3vd',2);
insert into account (id,email,name,hash_password,salt) values(14,'14@gmail.com','东方不败','48577990717ce63726608c92c6ab257f','4sG3vd');
insert into account (id,email,name,hash_password,salt) values(15,'15@gmail.com','张三','48577990717ce63726608c92c6ab257f','4sG3vd');
insert into account (id,email,name,hash_password,salt) values(16,'16@gmail.com','李四','48577990717ce63726608c92c6ab257f','4sG3vd');
insert into account (id,email,name,hash_password,salt) values(17,'17@gmail.com','王五','48577990717ce63726608c92c6ab257f','4sG3vd');
insert into account (id,email,name,hash_password,salt) values(18,'18@gmail.com','赵六','48577990717ce63726608c92c6ab257f','4sG3vd');

CREATE TABLE country (
	`id` INT(3) NOT NULL AUTO_INCREMENT COMMENT '主键',
	`countryname` VARCHAR(255) NULL DEFAULT NULL COMMENT '国家名',
	`countrycode` VARCHAR(255) NULL DEFAULT NULL COMMENT '国家代码',
	PRIMARY KEY (`id`)
)
COMMENT='国家信息'
ENGINE=InnoDB
